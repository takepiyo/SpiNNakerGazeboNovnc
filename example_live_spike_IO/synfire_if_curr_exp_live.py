...
populations.append(p.Population(1, p.external_devices.SpikeInjector(database_notify_port_num=12345), label="spike_injector"))
...
p.external_devices.activate_live_output_for(
    populations[0], database_notify_port_num=12345)
...
figure.save("./reports/figure.png")
