...
sh -c "echo \"alias cw='cd $ws/$name_catkin_workspace'\" >> ~/.bashrc"
sh -c "echo \"alias cs='cd $ws/$name_catkin_workspace/src'\" >> ~/.bashrc"
sh -c "echo \"alias cm='cd $ws/$name_catkin_workspace && catkin_make'\" >> ~/.bashrc"

sh -c "echo \"source /opt/ros/$name_ros_version/setup.bash\" >> ~/.bashrc"
sh -c "echo \"source $ws/$name_catkin_workspace/devel/setup.bash\" >> ~/.bashrc"
